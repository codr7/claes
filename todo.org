...
* fix scopes
** bara för att en symbol har frame_offset > 0 så betyder inte det att recalls
** ska läggas till.
** repl history ska fortfarande ha frame offset 1 trots att vi är i ett rekursivt anrop
